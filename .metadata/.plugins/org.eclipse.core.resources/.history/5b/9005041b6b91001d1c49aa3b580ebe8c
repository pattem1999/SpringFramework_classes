...
public class StudentDaoImp implements StudentDao {
	...
	public List<Student> show() {
		...
		List<Student> st = jdbc.query(sql, new StudentRetrive());
		return st;
	}

	/*
	 * @Override public void retrive(Student stu) { // TODO Auto-generated method
	 * stub jdbc=new JdbcTemplate(getSource()); String SQL =
	 * "select * from student where sid = ?"; Student
	 * student=jdbc.queryForObject(SQL, new Object[] {100},new StudentRetrive());
